...
<div class="container_echange">
    <?php foreach ($row as $demande){ ?>
        <div class="row rowM" style="height: 200px;">
            <div class="col-xxl-2"><a href="#"><img src="<?php echo base_url('assets/img/'.$demande['nom2'].'/'.$demande['iddemande'].'.jpg') ?>" style="width: 200px;height: 200px;"></a></div>
            ...
            <div class="col-xxl-2"><a href="#"><img src="<?php echo base_url('assets/img/'.$demande['nom1'].'/'.$demande['iddemandant'].'.jpg') ?>" style="width: 200px;height: 200px;"></a></div>
