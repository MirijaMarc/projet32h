<div class="container py-4 py-xl-5">
    ...
    <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
        ...
        <div class="col">
            <div class="card"><img class="card-img-top w-100 d-block fit-cover img_magasin" style="height: 292px;" src=<?php echo base_url('assets/img/'.$objet['nomcategorie'].'/'.$objet['id'].'/1.jpg') ?>>
