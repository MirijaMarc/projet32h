...
insert into objet(nomobjet,description,prix,iduser,idcategorie) values
    ('pantalon','Jean gris LEVIS de taille 32 du modele XXX',12000,2,1), --1
    ('tee-shirt','Tee-shirt Blue de taille XL ideale pour la plage',10000,4,1),--2
    ('short','Short beige taille 36 tres confortable ideale pour les rendonnee',7000,3,1), --3
    ('casquette','Casquette Red Bull Racing F1 kids 2022 signe par Verstapen',50000,1,1), --4
    ('gant','Thw Glove S22 Thor MX Spectrum, tres confortable, edition limitee ',25000,3,1),--5
    ('imprimante','Imprimante HP modele XXX 2019',50000,2,2),--6
    ('camera','Nikon 5D grande ouverture, avec zoom x3,x5,x10 ',80000,3,2),--7
    ('ordinateur','Asus XXX modele 2022 core i9 12267X, RTX 4090, SSD 2To',1500000,1,2),--8
    ('telephone','Samsung Galaxy S23 Ultra: snapdragon 8Gen2, 1To, Ram 12GO',1000000,3,2),--9
    ('tablette','Galaxie Tab s8 ultra: snapdragon 8Gen2, 1To, Ram 12GO',1200000,2,2),--10
    ('Harry Potter','Harry potter Tome 1 auteur J.K.Rowling vendu a 1 milliard d exemplaire',50000,5,3),--11
    ('Les miserables','Livre de poche ecrit par Victor Hugo vendu a 100000 exemplaire',30000,2,3),--12
    ('Orgeuil et prejuges','livre de poche ecrit par Jane Austen vendu 10000000 d exemplaire',40000,3,3),--13
    ('Le petit prince','Livre de poche ecrit par Antoine de Saint-Exupery edition XXX',20000,4,3),--14
    ('Art de la guerre','Livre de poche ecrit par Sun Zu vendu a 8000000 d exemplaire partout dans le monde',30000,3,3);--15
